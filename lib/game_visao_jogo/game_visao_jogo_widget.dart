...
class GameVisaoJogoWidget extends StatefulWidget {
  const GameVisaoJogoWidget({
    Key? key,
    this.gameRef,
  }) : super(key: key);
  ...
  @override
  _GameVisaoJogoWidgetState createState() => _GameVisaoJogoWidgetState();
}

class _GameVisaoJogoWidgetState extends State<GameVisaoJogoWidget>
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    containerGamesRecord.configurao!,
