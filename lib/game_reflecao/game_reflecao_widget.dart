...
class GameReflecaoWidget extends StatefulWidget {
  const GameReflecaoWidget({
    Key? key,
    this.gameRef,
  }) : super(key: key);
  ...
  @override
  _GameReflecaoWidgetState createState() => _GameReflecaoWidgetState();
}

class _GameReflecaoWidgetState extends State<GameReflecaoWidget>
